...
save(data,file="Results/data_hom.rda")
save(data_analysis,file="Results/data_analysis_hom.rda")
save(ecdf_random_tours_list,file="Results/ecdf_random_tours_list_hom.rda")
