...
Finally, we provide two extra R functions (in the *Functions* folder) that would allow the user to implement the main methods presented with different sets of instances:
